import type { Embedder, ToolCategory, ToolIMP, ToolProtocol, ToolResult, ToolSelector, VectorIndex, OverloadTableData, InvalidationHook, CacheVersionContext, DispatchEvent, InferenceDelta } from '../core/types';
import { ResolutionCache, computeSchemaFingerprint } from '../core/resolution-cache';
import { SelectorTable } from '../core/selector-table';
import { ToolClass } from '../core/tool-class';
import { OverloadTable } from '../core/overload-table';
import { DispatchContext, toolkit_dispatch, smallchat_dispatchStream } from './dispatch';
import type { DispatchConfig } from './dispatch';
import type { SCMethodSignature } from '../core/sc-types';
import { DispatchBuilder } from './dispatch-builder';
import { SelectorNamespace } from '../core/selector-namespace';
import type { LLMClient } from '../core/llm-client';
import type { DispatchObserver } from './observer';
...
export interface RuntimeOptions {
  ...
  rateLimiter?: import('../core/semantic-rate-limiter').SemanticRateLimiterOptions;
  ...
  observerOptions?: import('./observer').ObserverOptions;
}
