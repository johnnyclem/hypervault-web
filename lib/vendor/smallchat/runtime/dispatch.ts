import type { Embedder, ToolCandidate, ToolIMP, ToolProtocol, ToolResult, ToolSelector, VectorIndex, DispatchEvent, InferenceDelta } from '../core/types';
import { ResolutionCache } from '../core/resolution-cache';
import { SelectorTable, canonicalize, VectorFloodError } from '../core/selector-table';
import { ToolClass } from '../core/tool-class';
import { SCObject, wrapValue, unwrapValue } from '../core/sc-object';
import type { OverloadResolutionResult } from '../core/overload-table';
import { SelectorNamespace } from '../core/selector-namespace';
import { SignatureValidationError } from '../core/overload-table';
import { validateNamedArgumentTypes } from '../core/sc-types';
import { IntentPinRegistry } from '../core/intent-pin';
import type { IntentPinMatch } from '../core/intent-pin';
import { computeTier, requiresVerification, requiresDecomposition, requiresRefinement, createProof, addProofStep, DEFAULT_THRESHOLDS } from '../core/confidence';
import type { ConfidenceTier, ResolutionProof, TierThresholds } from '../core/confidence';
import type { LLMClient, ToolSummary } from '../core/llm-client';
import { NULL_LLM_CLIENT } from '../core/llm-client';
import { verify } from './verification';
import type { VerificationResult } from './verification';
import { decompose, executeDecomposition } from './decomposition';
import { refine, buildRefinementResult } from './refinement';
import { DispatchObserver } from './observer';
import type { ObserverOptions } from './observer';
