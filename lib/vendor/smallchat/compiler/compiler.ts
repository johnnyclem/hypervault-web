...
import { ToolClass, ToolProxy } from '../core/tool-class';
import { OverloadTable } from '../core/overload-table';
import { createSignature, param, SCType } from '../core/sc-types';
import type { SCTypeDescriptor, SCParameterSlot } from '../core/sc-types';
import { parseMCPManifest, applyManifestOverrides, type ParsedTool } from './parser';
import type { SmallChatManifest } from '../core/manifest';
